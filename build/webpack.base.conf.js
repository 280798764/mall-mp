...
var staticFileConf = require('../config/staticFileConf')
var requestUrlConfig = require('../config/requestUrlConfig')
    ...
    rules: [
      ...
      },
      {
        ...
        options: {
          arr:[
            {
              search: '$STATIC_URL',
              replace: staticFileConf[process.argv.slice(2)[1] || 'other'],
              attr: 'g'
            },
            {
              search: '$REQUEST_URL',
              replace: requestUrlConfig[process.argv.slice(2)[1] || 'other'],
              attr: 'g'
            }
          ]
        }
      ...
      },
      {
        ...
        options: {
          limit: 10000,
          // name: utils.assetsPath('img/[name].[ext]'),
          publicPath: JSON.stringify(staticFileConf[process.argv.slice(2)[1] || 'other'])
        }
      },
      {
